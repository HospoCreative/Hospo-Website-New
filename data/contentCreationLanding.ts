...
export const contentCreationPackages: CommercialItem[] = [
  {
    ...
    included_items: ["Up to 3-hour content shoot", "25–30 professionally edited photos", "2 edited short-form vertical videos", "Content tailored to the business, brand and key areas they want to promote", "Delivered ready for social media, web and digital campaigns"],
  ...
  },
  {
    ...
    included_items: ["Up to 4-hour content shoot", "35–45 professionally edited photos", "3 edited short-form vertical videos", "Broader content coverage across the business, products, services, atmosphere and experience", "More variety of scenes, details and moments captured during the shoot", "Delivered ready for social media, web and digital campaigns"],
