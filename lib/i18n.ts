...
const pt: Record<string, string> = {
  ...
  ,"Andreia leads marketing strategy, brand positioning, campaigns, social media, advertising, SEO and digital communication. With more than seven years of hospitality marketing experience, she helps hotels and restaurants strengthen their presence and turn attention into measurable growth.": "Andreia lidera a estratégia de marketing, o posicionamento de marca, campanhas, redes sociais, publicidade, SEO e comunicação digital. Com mais de sete anos de experiência em marketing para hotelaria, ajuda hotéis e restaurantes a reforçar a sua presença e a transformar atenção em crescimento mensurável."
  ,"Tiago leads photography, video, web development and visual production, supported by approximately 15 years of industry experience. He also drives business development and commercial strategy, connecting creative execution with the long-term direction of Hospo.": "Tiago lidera a fotografia, vídeo, desenvolvimento web e produção visual, com cerca de 15 anos de experiência no setor. Também impulsiona o desenvolvimento de negócio e a estratégia comercial, ligando a execução criativa à direção de longo prazo da Hospo."
