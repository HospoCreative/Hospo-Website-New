...
import { serviceSeo } from "@/data/seoContent";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const seo = serviceSeo[slug]?.[locale];
  return buildPageMetadata({ title: seo?.title ?? `${translate(locale, service.title)} | Hospo Creative`, description: seo?.description ?? detail?.heroDescription ?? service.description, pathname: `/services/${slug}`, locale });
}
