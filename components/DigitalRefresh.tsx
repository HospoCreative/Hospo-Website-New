    ...
    <section id="digital-refresh" className="bg-white px-5 py-[var(--hc-section)] text-ink sm:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-9 flex flex-col gap-3 sm:flex-row">
          <a href={localizedPath("/services", locale)} className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-ink px-5 py-3 text-xs font-black uppercase tracking-[0.15em] text-white transition hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink focus-visible:ring-offset-2 focus-visible:ring-offset-white">{translate(locale, "Explore the Digital Refresh")} <ArrowUpRight size={16} aria-hidden="true" /></a>
          <a href={localizedPath("/digital-scan", locale)} className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full border border-ink/40 px-5 py-3 text-xs font-black uppercase tracking-[0.15em] text-ink transition hover:-translate-y-0.5 hover:border-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink">{translate(locale, "Digital Presence Review")} <ArrowUpRight size={16} aria-hidden="true" /></a>
        </div>
      </div>
    </section>
  );
