    ...
    <section className="bg-ink px-5 py-[var(--hc-section-compact)] text-white sm:px-8">
      <div className="mx-auto max-w-7xl border-y border-white/16 py-10 sm:py-12">
        ...
        <div className="mt-8 flex flex-col items-start gap-3 sm:flex-row sm:flex-wrap">
          <a href="#digital-review" className="button-primary">{content.primaryCta}<ArrowUpRight size={17} aria-hidden="true" /></a>
          <a href="#work" className="button-secondary">{content.secondaryCta}<ArrowUpRight size={17} aria-hidden="true" /></a>
