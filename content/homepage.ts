export const homepageContent = {
  ...
  refresh: {
    ...
    pathways: [
      ...
      },
      {
        ...
        body: "For businesses needing stronger content, website presentation, Google visibility and OTA performance.",
        items: ["Website content review", "Google Business Profile", "OTA image and copy review", "Booking journey review", "Conversion recommendations"]
      },
      {
        title: "Growth Support",
        body: "For businesses needing ongoing marketing, optimisation and campaign support.",
        items: ["Content planning", "Social media management", "SEO and paid media", "Email marketing", "Reporting and consultancy"]
      }
    ]
  },
  testimonials: {
    ...
    items: [
      ...
      },
      {
        ...
        title: "Marketing & Communications Manager, Pan Pacific Hanoi",
        quote:
          "The photos and video turned out absolutely stunning, you captured the ambiance and culinary highlights beautifully, even despite the rainy weather."
      },
      {
        name: "Raj Rana",
  ...
  statistics: {
    eyebrow: "Why digital presence matters",
    title: "Your guests make decisions before they arrive.",
    body:
  ...
  journey: {
    eyebrow: "The digital guest journey",
    title: "Every digital touchpoint influences the booking decision.",
    body: "Guests may discover a business through social media, compare it on Google or an OTA, visit the website and return later through an advertisement or email. Those moments should feel connected.",
    stages: [
      { title: "Discover", body: "Social media, search, advertising and recommendations create the first impression." },
      { title: "Compare", body: "Photography, reviews, websites and booking platforms shape the shortlist." },
      { title: "Trust", body: "Clear information, consistent presentation and useful content reduce uncertainty." },
      { title: "Book", body: "A simple website, booking link or enquiry journey turns interest into action." },
      { title: "Return", body: "Email, campaigns and continued communication keep the relationship active." }
    ]
  },
  review: {
  ...
  faq: {
    ...
    items: [
      ...
      { question: "How can SEO help a hotel or restaurant attract more direct bookings or reservations?", answer: "SEO helps your business appear for relevant searches when guests are researching where to stay or eat. We improve the pages, information and technical foundations that help potential guests understand your offer and take the next step on your website." },
      { question: "What is the difference between SEO, AEO and GEO?", answer: "SEO improves visibility in traditional search. AEO makes information clearer for question-based search. GEO helps AI tools understand a brand’s location, offer and differentiation. Together, they strengthen how a hospitality business can be found and understood online." },
      { question: "What improves local search visibility for a hotel or restaurant?", answer: "Accurate and consistent business information, a well-managed Google Business Profile, useful location-led website content, strong photography, current reviews and clear details about services, menus, rooms or amenities all help guests find and trust a local hospitality business." },
      { question: "Can you guarantee a hotel or restaurant will appear in Google or AI search results?", answer: "No. Search engines and AI platforms decide which results to show. We focus on the quality, accuracy and structure of your digital presence so your business is easier for people and platforms to find, understand and compare." },
